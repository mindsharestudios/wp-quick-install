	...
	if(is_writable($parent_dir)) {
		...
		<table class="form-table">
			...
			<tr>
				...
				<td colspan="2"><label><input type="checkbox" id="blog_public" name="blog_public" value="1" checked="checked" /> <?php echo _('Allow search engines to index this site.'); ?></label>
				</td>
			</tr>
		</table>
		...
		<table class="form-table">
			...
			<tr>
				...
				<td colspan="2"><label><input type="checkbox" id="delete_default_themes" name="delete_default_themes" value="1" /> <?php echo _('Delete the default themes (Twenty Family).'); ?>
					</label></td>
			</tr>
		</table>
		...
		<table class="form-table">
			<tr>
				...
				<td>
					<code>http://<?php echo $_SERVER['SERVER_NAME']; ?></code> <input name="permalink_structure" type="text" id="permalink_structure" size="50" value="/%postname%/" />
				</td>
			</tr>
		</table>
		...
		<table class="form-table">
			<tr>
				...
				<td>
					...
					<label for="thumbnail_crop" class="small-text"><input name="thumbnail_crop" type="checkbox" id="thumbnail_crop" value="1" checked="checked" /><?php echo _('Resize images to get the exact dimensions'); ?>
					</label>
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td>
					...
					<label for="uploads_use_yearmonth_folders" class="small-text"><input name="uploads_use_yearmonth_folders" type="checkbox" id="uploads_use_yearmonth_folders" value="1" checked="checked" /><?php echo _('Organize my files in monthly and annual folders') ?>
					</label>
				</td>
			</tr>
		</table>
				...
				<td>
					<label><input type="checkbox" name="debug" id="debug" value="1" /> <?php echo _('Enable WordPress debug mode</label><p>By checking this box, WordPress will displaying errors</p>'); ?>
						...
						<div id="debug_options" style="display:none;">
							<label><input type="checkbox" name="debug_display" id="debug_display" value="0" /> <?php echo _('Enable WP Debug'); ?></label> <br />
